...
namespace Mapbox.Editor
{
    ...
    public class MapManagerEditor : Editor
    {
        ...
        bool ShowBiomGenerator
        {
            get
            {
                return EditorPrefs.GetBool(objectId + "MapManagerEditor_showBiomGenerator");
            }
            set
            {
                EditorPrefs.SetBool(objectId + "MapManagerEditor_showBiomGenerator", value);
            }
        }
