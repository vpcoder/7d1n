...
namespace Engine.Data.Quests
{
    ...
    public class NyasevskStartQuest : QuestInfo
    {
        ...
        public NyasevskStartQuest() : base() { }
        public NyasevskStartQuest(SerializationInfo info, StreamingContext context) : base(info, context) { }
