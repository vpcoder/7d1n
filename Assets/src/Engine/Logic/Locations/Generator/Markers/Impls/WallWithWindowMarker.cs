...
namespace Engine.Logic.Locations.Generator.Markers
{
    ...
    public class WallWithWindowMarker : MarkerBase
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            Gizmos.DrawCube(Position + q * (new Vector3(-bounds.x * 0.5f, bounds.y * 0.5f, bounds.z)), q * new Vector3(bounds.x * 0.4f, bounds.y * 0.4f, bounds.z * 0.4f));
        }
