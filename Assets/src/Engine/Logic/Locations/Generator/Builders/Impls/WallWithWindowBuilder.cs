    ...
    public class WallWithWindowBuilder : BuilderBase<WallWithWindowMarker>
    {
        ...
        public override void Build(GenerationRoomContext context)
        {
            ...
            foreach (var abstractMarker in currentMarks) {
                ...
                GameObject.Instantiate<GameObject>(context.BuildingElement.InsideWallWithWindow, position, rotation, BuildParent);
                ...
                GameObject.Instantiate<GameObject>(abstractMarker.IsTwoSide ? context.BuildingElement.InsideWallWithWindow : context.BuildingElement.OutsideWallWithWindow, position, rotation, BuildParent);
            }
        }
