...
namespace Engine.Story.Nyasevsk
{
    ...
    public class StartInTheBedStoryCatcher : StoryBase
    {
        ...
        public override string StoryID => "main.nyasevsk1.start_in_the_bed";
        ...
        public override void CreateDialog(DialogQueue dlg)
        {
            ...
            dlg.Run(() =>
            {
                ...
                QuestFactory.Instance.Get<NyasevskStartQuest>().AddTag(NyasevskStartQuest.CheckPointCharacterWakeup);
            });
        }
