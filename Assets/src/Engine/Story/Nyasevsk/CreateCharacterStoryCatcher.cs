...
namespace Engine.Story.Nyasevsk
{
    ...
    {
        public override string StoryID => "main.nyasevsk1.create_character";
        ...
        {
            var quest = QuestFactory.Instance.Get<NyasevskStartQuest>();
            if (zombie != null && quest.ContainsTag(NyasevskStartQuest.CheckPointKillZombie))
            {
            ...
            if(quest.NotContainsTag(NyasevskStartQuest.CheckPointCharacterWakeup))
